  ...
  return (
    <>
      ...
      <SectionTitle 
        ...
        subtitle={`Student Detail( Exam: ${student?.exam?.name})`} 
        right={
          (
            <div>
              <Excel student={student} />
      ...
      <Grid container spacing={3}>
        ...
        <Grid item md={8} sm={6} xs={12}>
          <Grid container spacing={2}>
            ...
            {student?.exam?.templateType === 'improve' &&
              <Grid item xs={12}>
                <ImproveDetail template={student?.exam?.improveTemplate} />
              </Grid>
            }
          </Grid>
        </Grid>

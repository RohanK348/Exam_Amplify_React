...
import {getByPagination as getPrices} from '../../../../../api/priceCorporate'
...
const columns = [
  ...
  { id: 'number', label: 'Candidate', minWidth: 100, align: 'center' },
  {
    id: 'action',
    label: 'Action',
    minWidth: 170,
...
const PriceCorporate = () => {
  ...
  return (
    <>
      ...
      <SectionTitle title="Corporate Price" subtitle="Corporate Price management" />
      <Widget
                          ...
                          {column.id === 'action'?
                            (
                              <>
                                ...
                                <Link to={`/admin/corporate/coupon/${row.id}`} style={{textDecoration: 'none'}}>
